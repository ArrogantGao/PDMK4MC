...
// Extend SCTL's EvalPolynomial to support 17-33 order polynomials
namespace sctl {
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c14, const CType &c15, const CType &c16) {
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     const CType &c4, const CType &c5, const CType &c6, const CType &c7, const CType &c8,
                     const CType &c9, const CType &c10, const CType &c11, const CType &c12, const CType &c13,
                     const CType &c14, const CType &c15, const CType &c16, const CType &c17) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        x16, fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16)),
        fma_intrin(x8,
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)),
                                         fma_intrin(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12))),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
    ...
    return fma_intrin(
        x16, fma_intrin(x2, set1_intrin<VData>(c18), fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16))),
        fma_intrin(x8,
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)),
                                         fma_intrin(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12))),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c9, const CType &c10, const CType &c11, const CType &c12, const CType &c13,
                     const CType &c14, const CType &c15, const CType &c16, const CType &c17, const CType &c18,
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        ...
        fma_intrin(
            x4,
            fma_intrin(x2, set1_intrin<VData>(c22), fma_intrin(x1, set1_intrin<VData>(c21), set1_intrin<VData>(c20))),
            fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)),
                       fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16)))),
        fma_intrin(x8,
                   fma_intrin(x4,
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c9, const CType &c10, const CType &c11, const CType &c12, const CType &c13,
                     const CType &c14, const CType &c15, const CType &c16, const CType &c17, const CType &c18,
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22, const CType &c23) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        x16,
        fma_intrin(x4,
                   fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)),
                              fma_intrin(x1, set1_intrin<VData>(c21), set1_intrin<VData>(c20))),
                   fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)),
                              fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16)))),
        fma_intrin(x8,
                   fma_intrin(x4,
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
    ...
    return fma_intrin(
        x16,
        fma_intrin(x8, set1_intrin<VData>(c24),
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)),
                                         fma_intrin(x1, set1_intrin<VData>(c21), set1_intrin<VData>(c20))),
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c14, const CType &c15, const CType &c16, const CType &c17, const CType &c18,
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22, const CType &c23,
                     const CType &c24, const CType &c25, const CType &c26, const CType &c27) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        x16,
        fma_intrin(x8,
                   fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c27), set1_intrin<VData>(c26)),
                              fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24))),
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)),
                                         fma_intrin(x1, set1_intrin<VData>(c21), set1_intrin<VData>(c20))),
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c14, const CType &c15, const CType &c16, const CType &c17, const CType &c18,
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22, const CType &c23,
                     const CType &c24, const CType &c25, const CType &c26, const CType &c27, const CType &c28) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        x16,
        fma_intrin(x8,
                   fma_intrin(x4, set1_intrin<VData>(c28),
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c27), set1_intrin<VData>(c26)),
                                         fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24)))),
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
    ...
    return fma_intrin(
        x16,
        fma_intrin(x8,
                   fma_intrin(x4, fma_intrin(x1, set1_intrin<VData>(c29), set1_intrin<VData>(c28)),
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c27), set1_intrin<VData>(c26)),
                                         fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24)))),
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22, const CType &c23,
                     const CType &c24, const CType &c25, const CType &c26, const CType &c27, const CType &c28,
                     const CType &c29, const CType &c30) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        ...
        fma_intrin(x8,
                   fma_intrin(x4,
                              fma_intrin(x2, set1_intrin<VData>(c30),
                                         fma_intrin(x1, set1_intrin<VData>(c29), set1_intrin<VData>(c28))),
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c27), set1_intrin<VData>(c26)),
                                         fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24)))),
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)),
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22, const CType &c23,
                     const CType &c24, const CType &c25, const CType &c26, const CType &c27, const CType &c28,
                     const CType &c29, const CType &c30, const CType &c31) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
    ...
    return fma_intrin(
        ...
        fma_intrin(x8,
                   fma_intrin(x4,
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c31), set1_intrin<VData>(c30)),
                                         fma_intrin(x1, set1_intrin<VData>(c29), set1_intrin<VData>(c28))),
                              fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c27), set1_intrin<VData>(c26)),
                                         fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24)))),
                   fma_intrin(x4,
...
VData EvalPolynomial(const VData &x1, const CType &c0, const CType &c1, const CType &c2, const CType &c3,
                     ...
                     const CType &c19, const CType &c20, const CType &c21, const CType &c22, const CType &c23,
                     const CType &c24, const CType &c25, const CType &c26, const CType &c27, const CType &c28,
                     const CType &c29, const CType &c30, const CType &c31, const CType &c32) {
    VData x2(mul_intrin<VData>(x1, x1));
    VData x4(mul_intrin<VData>(x2, x2));
    VData x8(mul_intrin<VData>(x4, x4));
    VData x16(mul_intrin<VData>(x8, x8));
