...
namespace ewald {
    ...
    EwaldConfig::EwaldConfig(const double Lx, const double Ly, const double Lz, const double s, const double alpha, const double eps)
    ...
    EwaldConfig::~EwaldConfig() {
        std::cout << "Destroying EwaldConfig class" << std::endl;
    }

    double EwaldConfig::compute_energy(const sctl::Vector<double> &q, const sctl::Vector<sctl::Vector<double>> &r) {
