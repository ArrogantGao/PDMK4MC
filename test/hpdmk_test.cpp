...
void compare_direct() {
    ...
    ASSERT_NEAR(E_window, E_window_direct, 1e-6);
    ASSERT_NEAR(E_difference, E_difference_direct, 1e-6);
    ASSERT_NEAR(E_residual, E_residual_direct, 1e-6);
    ...
    for (int i = 0; i < nrounds; i++) {
        ...
        ASSERT_NEAR(p_window, p_window_direct, 1e-6);
        ASSERT_NEAR(p_difference, p_difference_direct, 1e-6);
        ASSERT_NEAR(p_residual, p_residual_direct, 1e-6);
    }
}
